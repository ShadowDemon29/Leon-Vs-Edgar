...
function preload(){
  ...
  climberImg = loadImage("Zeus God of lightning (2).png");
  ghostImg = loadImage("Grime Reaper.jpg");
...
function draw(){
  ...
  if (gameState === "play") {
    ...
    fill ("Black")
    textSize(20)
    text("Dodge Zeus Who Want's To Defeat You",70,70) 
    text("Don't Let The Reaper Fall",70,95)
